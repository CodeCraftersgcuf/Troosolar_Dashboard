...
const Terms = ({ link, onClose }) => {
  ...
  const termsContent = [
    ...
    },
    {
      ...
      content:
        "These terms are governed under the laws of [Insert Jurisdiction].",
    },
    {
      title: "10. Contact Us",
  ...
  const MobileSheet = () => (
    <div className="sm:hidden bg-white rounded-2xl shadow-md overflow-hidden flex flex-col w-[92vw] max-w-[430px] max-h-[88vh]">
      ...
      <div className="px-5 text-sm flex-1 flex flex-col">
        ...
        <div
          className={`border-2 border-[#273e8e] rounded-2xl flex-1 overflow-hidden ${
            isCreditScorePage ? "max-h-[400px]" : "max-h-[60vh]"
          }`}
        >
          ...
          <div className="overflow-y-auto px-4 pb-4 pt-2 space-y-3 h-full">
            <p>
              ...
              platform ("Service"), you agree to be bound by the following Terms
              of Usage. Please read them carefully before applying for a loan.
            </p>
  ...
  const DesktopSheet = () => (
    <div className="hidden sm:flex w-[100%] h-[610px] bg-white rounded-2xl shadow-md overflow-hidden flex-col">
      ...
      <div className="px-6 text-sm flex-1 flex flex-col max-h-[450px]">
        ...
        <div
          className={`border rounded-2xl flex-1 ${
            isCreditScorePage ? "max-h-[400px]" : "max-h-[600px]"
          } flex flex-col`}
        >
