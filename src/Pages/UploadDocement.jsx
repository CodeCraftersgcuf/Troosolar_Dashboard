...
const UploadDocument = () => {
  ...
  // ---------- Helpers for progress (mobile 1/2 & 2/2 like the mock) ----------
  const mobileStepIndex = isUploadDocumentPage ? 1 : isBeneficiaryPage ? 2 : 3;
  const mobileStepCount = isLoanPage ? 3 : 2; // your mock shows 1/2 and 2/2; loan step remains 3/3 if reached
          ...
          <main className="bg-[#F5F7FF] p-5 pb-28">
            ...
            <div className="mb-4">
              <h1 className="text-[20px] font-semibold text-gray-900">
                ...
                {isLoanPage && (
                  <>
                    Loan Details (<span className="text-[#273e8e]">3</span>/3)
                  </>
                )}
              </h1>
              <p className="text-[12px] text-gray-500 mt-1">
                ...
                {isLoanPage && "Please provide your loan information"}
              </p>
